...
class SmartQ_ADataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank):
        super().__init__(output_path, seed, local_rank)
        self.dataset_name = "Smart/Q_A"
        self.dataset_name_clean = "Smart"
        self.raw_datasets =  load_dataset("json", data_files={'train':'/root/nas-share/chat/DeepSpeed-Chat/as1.json','test':'/root/nas-share/chat/DeepSpeed-Chat/as1.json'})
...
class DahoasRmstaticDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_dataset("/root/nas-share/chat/DeepSpeed-Chat/Dahoas/rm-static")
